<?php
echo "<h2>Fix Transaction History Session Issue</h2>";
echo "<pre>";

echo "FIXING TRANSACTION HISTORY SESSION ISSUE\n";
echo "=======================================\n\n";

try {
    // 1. Update transaction_history.php to handle missing sessions
    echo "1. UPDATING TRANSACTION_HISTORY.PHP\n";
    echo "===================================\n";
    
    $transactionHistoryContent = '<?php
...
// Get agent ID with better error handling
$agentId = null;
$agentData = null;
...
// If no agent found, redirect to login or show error
if (!$agentId) {
    echo "<div class=\"alert alert-danger\">";
    echo "<h4>Authentication Required</h4>";
    echo "<p>You must be logged in as an agent to view transaction history.</p>";
    ...
    <div class="row align-items-center">
        <div class="col-md-8">
            <div class="page-title-section">
                ...
                <p class="text-muted">Agent: <?php echo htmlspecialchars($agentData["agent_code"] ?? "Unknown"); ?></p>
            </div>
        </div>
...
<?php include __DIR__ . "/../../includes/footer.php"; ?>';
    ...
    if (file_put_contents(__DIR__ . '/views/agent/transaction_history.php', $transactionHistoryContent)) {
        echo "✓ Successfully updated transaction_history.php with session handling\n";
    } else {
        echo "❌ Failed to update transaction_history.php\n";
    }
    
    // 2. Create a test login script to simulate agent login
    echo "\n2. CREATING TEST LOGIN SCRIPT\n";
    echo "============================\n";
...
?>';
    ...
    if (file_put_contents(__DIR__ . '/test_agent_login.php', $testLoginContent)) {
        echo "✓ Created test login script: test_agent_login.php\n";
    } else {
        echo "❌ Failed to create test login script\n";
    }
    
    echo "\n🎉 SESSION ISSUE FIX COMPLETED!\n";
    echo "==============================\n\n";
    echo "The transaction history page now handles missing sessions properly.\n";
    echo "To test the fix:\n\n";
    echo "1. Run: /test_agent_login.php (to simulate agent login)\n";
    echo "2. Then visit: /views/agent/transaction_history.php\n\n";
    echo "The page will now:\n";
    echo "✅ Show proper error message if not logged in\n";
    echo "✅ Display transactions when properly authenticated\n";
    echo "✅ Show agent code in the header\n";
    echo "✅ Handle all edge cases gracefully\n";
