...
class ActivityLogger {
    ...
    public static function getUserActivitiesFiltered($userId = null, $activityType = 'all', $fromDate = null, $toDate = null, $limit = 100) {
        self::init();
        ...
        if ($userId && $userId !== 'all') {
            $whereConditions[] = 'ua.user_id = :user_id';
            $params[':user_id'] = $userId;
        }
        
        // Activity type filter
        if ($activityType && $activityType !== 'all') {
            $whereConditions[] = 'ua.activity_type = :activity_type';
            $params[':activity_type'] = $activityType;
        }
        
        // Date range filter
        if ($fromDate && $toDate) {
            $whereConditions[] = 'DATE(ua.created_at) BETWEEN :from_date AND :to_date';
