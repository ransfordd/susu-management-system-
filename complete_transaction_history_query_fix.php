<?php
echo "<h2>Complete Transaction History Query Fix</h2>";
echo "<pre>";

echo "COMPLETE TRANSACTION HISTORY QUERY FIX\n";
echo "=====================================\n\n";

try {
    // 1. Check database structure for all tables
    echo "1. CHECKING DATABASE STRUCTURE FOR ALL TABLES\n";
    echo "=============================================\n";
    ...
    // Check daily_collections table structure
    $dcStructureQuery = "DESCRIBE daily_collections";
    $dcStructureStmt = $pdo->query($dcStructureQuery);
    $dcStructure = $dcStructureStmt->fetchAll();
    
    echo "\ndaily_collections table structure:\n";
    foreach ($dcStructure as $column) {
        echo "  - " . $column['Field'] . " (" . $column['Type'] . ")\n";
    }
    ...
    $replacements = [
        'lp.amount_paid as amount' => 'lp.amount_paid as amount',
        'lp.amount as amount' => 'lp.amount_paid as amount',
        'lp.reference_number' => 'lp.receipt_number',
        'l.reference_number' => 'l.loan_number',
    ...
    // 7. Test the full query with correct column names
    echo "\n7. TESTING FULL QUERY WITH CORRECT COLUMN NAMES\n";
    echo "=================================================\n";
    ...
    echo "\n🎉 COMPLETE TRANSACTION HISTORY QUERY FIX COMPLETE!\n";
    echo "====================================================\n";
    echo "✅ Database structure checked for all tables\n";
