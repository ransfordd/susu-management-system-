<?php
echo "<h2>Fixed Parameter Binding Test</h2>";
echo "<pre>";

echo "FIXED PARAMETER BINDING TEST\n";
echo "=============================\n\n";
...
try {
    ...
    $recentStmt->bindValue(':agent_id', $_SESSION['user_id'], PDO::PARAM_INT);
    $recentStmt->execute();
    ...
    $simpleStmt->bindValue(':agent_id', $_SESSION['user_id'], PDO::PARAM_INT);
    $simpleStmt->execute();
    $simpleResults = $simpleStmt->fetchAll();
    ...
    echo "\n🎉 FIXED PARAMETER BINDING TEST COMPLETE!\n";
    echo "==========================================\n";
    echo "✅ All components are working correctly\n";
    echo "✅ Database has proper time data\n";
    echo "✅ Query includes time fields\n";
