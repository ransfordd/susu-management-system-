...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <!-- Modern Quick Stats (NO deposits or revenue) -->
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <div class="modern-card">
                        ...
                        <div class="card-body-modern">
                            <div class="d-grid gap-2">
                                ...
                                <a href="?action=financial&report_type=withdrawals&from_date=<?php echo date('Y-m-d'); ?>&to_date=<?php echo date('Y-m-d'); ?>" class="modern-btn btn-warning">
                                    <i class="fas fa-money-bill-wave"></i> Today's Withdrawals
                                </a>
                            </div>
                        </div>
                    </div>
