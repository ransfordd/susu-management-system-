...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        <a href="/views/admin/dashboard.php" class="btn btn-outline-primary">Back to Dashboard</a>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-bell"></i> All System Notifications
                </h5>
            </div>
            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">
                                            User: <?php echo htmlspecialchars($notification['first_name'] . ' ' . $notification['last_name']); ?> 
                                            (<?php echo htmlspecialchars(ucfirst($notification['role'])); ?>)
                                            <?php if ($notification['reference_id']): ?>
                                            | Reference ID: <?php echo htmlspecialchars($notification['reference_id']); ?>
                                            <?php endif; ?>
                                        </small>
                                    </div>
                                </div>
